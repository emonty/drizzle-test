...
"""Defines the adapter for Valgrind's callgrind profiler tool"""
...
"""A class which wraps cache profiling around a server"""
class CachegrindProfiler:
  ...
  def getStartCmdPrefix(self):
    ...
    return "libtool --mode=execute valgrind --log-file=%s --tool=cachegrind --branch-sim=yes" % self._log_file
